...
private val englishStrings = SmartVisionStrings(
    ...
    recorderSubtitle = "Choose an EPG or manual duration. The recording engine will be connected in the next lot.",
...
private val frenchStrings = SmartVisionStrings(
    ...
    recorderTitle = "Recorder",
    recorderSubtitle = "Choisissez une duree EPG ou manuelle. Le moteur d'enregistrement sera connecte au lot suivant.",
