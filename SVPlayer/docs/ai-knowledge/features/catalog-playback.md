...
- 2026-07-18: le mini-player et le fullscreen Live reutilisent une unique `LivePlaybackSession`/instance ExoPlayer. Le second OK anime le viewport vers le plein ecran en 320 ms, Back le replie en 240 ms, et la surface est rattachee sans second flux audio. Le premier niveau Live suit la maquette: gradient bas, logo, titre/EPG, precedent, pause, suivant, luminosite et sortie; les options restent dans le panneau D-pad bas/Menu.
