...
- 2026-07-22: apres un zapping Haut/Bas, le player Live affiche pendant 3 secondes un guide gauche transparent et non interactif, borne a deux chaines precedentes, la chaine courante et deux suivantes. La fenetre vient de Room, reste dans la categorie courante, suit l'ordre numero/nom/streamId et ne boucle pas aux extremites. La chaine courante porte le focus visuel sans voler le focus reel du player.
