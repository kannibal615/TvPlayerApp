...
Depuis le 2026-07-17, l'enrichissement de l'historique episode reconnait aussi `Serie/Series <id>` comme titre genere. Il resout la serie par episode, `parentContentId`, puis identifiant extrait et corrige les anciennes lignes Room au prochain enrichissement, sans migration.
