...
Les cards Tendances HOME preparent leur preview seulement apres `550 ms` de focus stable: lien film Xtream ou premier episode Xtream disponible pour une serie. YouTube/TMDB trailer n'est plus utilise sur Home. Le cache Room `home_trending_preview_cache` stocke seulement type/id/extension/position; l'URL credentialisee est reconstruite en memoire.
