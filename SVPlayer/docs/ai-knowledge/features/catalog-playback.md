...
- Overlay plein ecran Live TV: la video reste plein ecran; logo SmartVision en haut gauche, numero de chaine en haut droite, bandeau bas full-width colle aux bords bas/gauche/droite avec effet verre, logo chaine, nom, ligne EPG si disponible et boutons `EPG`, `Settings`, `Record`, `Back to List`. Live TV n'affiche plus pause, -10s, +10s, fullscreen ni barre de progression. `Record` est un placeholder avec TODO DVR.
...
- 2026-07-05: overlay plein ecran Live TV remplace par un modele dedie direct: bandeau bas full-width, EPG lateral local, panneau Settings aspect ratio, Record placeholder et suppression des controles VOD.
