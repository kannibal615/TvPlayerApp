...
- Films: categories conservees, liste centrale paginee, preview a droite, puis lecteur fullscreen au bouton `Play` ou deuxieme OK sur la meme ligne. La fiche detail film s'ouvre uniquement via le bouton `Details` du panneau preview. Apres changement de profil ou premier chargement sans historique, l'ecran ouvre `ALL` ou une categorie avec contenu plutot que `Historique` vide.
- Series: categories conservees, liste centrale paginee, preview a droite sur l'episode repris ou le premier episode, puis lecteur episode au bouton `Play` ou deuxieme OK sur la meme ligne. La fiche detail serie avec saisons/episodes s'ouvre uniquement via le bouton `Details` du panneau preview. Apres changement de profil ou premier chargement sans historique, l'ecran ouvre `ALL` ou une categorie avec contenu plutot que `Historique` vide.
