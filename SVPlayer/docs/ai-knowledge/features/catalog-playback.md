...
- Overlay plein ecran Live TV: la video reste plein ecran; logo SmartVision en haut gauche, numero de chaine reel en haut droite, bandeau bas rectangulaire full-width plus bas/compact avec effet verre, logo chaine sans cadre, nom, ligne EPG locale si disponible et boutons `EPG`, `Settings`, `Record`, `Back to List`. Live TV n'affiche plus pause, -10s, +10s, fullscreen ni barre de progression. `Record` est un placeholder avec TODO DVR.
