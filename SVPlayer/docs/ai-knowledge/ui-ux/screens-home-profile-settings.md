...
- Sur Home, les cards tendances films/series utilisent `TrendingContentRow`: portrait par defaut, focus court sans player, stabilisation `1,3s`, ancrage gauche de la card focussee, transformation 16:9, crossfade vers backdrop, fallback poster floute si aucun backdrop, puis mini-player Media3 muet seulement apres transformation. Le preview demarre a environ 15% de la duree connue et tente 30% si la premiere frame n'arrive pas.
