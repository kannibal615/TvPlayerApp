...
- Toutes les saisies PIN visibles dans Settings, Info compte et le picker utilisent `NumericPinDialog`: pave 0-9, retour chiffre, CLR, validation/annulation, PIN masque et navigation D-pad sans clavier Android complet.
