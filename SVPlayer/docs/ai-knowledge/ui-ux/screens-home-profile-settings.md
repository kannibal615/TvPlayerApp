...
- Continue repare les anciens titres generiques `Serie/Series <id>` depuis l'episode, `parentContentId` puis l'identifiant extrait. Les films et directs portent un badge noir `FILM`/`LIVE`; les series n'ont pas de badge de type.
