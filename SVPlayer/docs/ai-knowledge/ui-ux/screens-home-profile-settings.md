...
- Un clic direct sur une card Live TV/Movies/Series declenche un container transform Compose reversible en deux mouvements: la card complete rejoint le centre avec un leger agrandissement, puis s'etend et revele le vrai catalogue sous le header. Le header reste partage et stable, les autres navigations conservent leur comportement, et D-pad/OK/Back restent bloques jusqu'a la fin. Back rejoue le chemin inverse et restaure le focus de la card source.
...
- Live TV, Movies et Series mesurent les bounds reels de leur mini-player. A l'ouverture du lecteur, la surface video se deplace d'abord au centre, s'agrandit legerement puis remplit progressivement l'ecran; le retour replie le lecteur par le chemin inverse. Les touches TV sont consommees pendant ce morphing et les controles n'apparaissent qu'apres stabilisation.
