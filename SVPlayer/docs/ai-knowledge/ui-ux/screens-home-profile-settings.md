...
- 2026-07-20: header principal ajuste avec les six PNG custom transparents: suppression du rail sous les icones et du glow de focus local, icones agrandies a la taille du bloc droit hors focus puis reduites au focus/selection pour afficher le label. La hauteur reste `44 dp`.
