...
- `HomeViewModel` ne rafraichit plus automatiquement les tendances lourdes a l'initialisation. Films reste lu depuis Room; Series revalide la selection Room bornee avec notes normalisees sur `5`, minimum `3/5`, recent puis meilleur fallback, et remplace `trending_media` seulement si la selection persistante est obsolete.
