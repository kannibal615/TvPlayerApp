...
Apres attribution du focus initial ou rafraichissement depuis le bouton Home du header, Home restabilise aussi le scroll a zero au frame suivant. Le spacer header/hero est place dans la zone scrollable et reprend la meme dimension que le spacer hero/categories afin d'absorber le `bringIntoView` automatique sans tronquer le bord superieur du hero; les positions Continue Watching/Tendances incluent ce bloc complet.
