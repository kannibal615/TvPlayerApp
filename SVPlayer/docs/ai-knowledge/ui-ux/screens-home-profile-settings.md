...
- Info compte > Profils: OK sur une ligne profil selectionne uniquement la fiche inline en bas; le toggle ON/OFF a droite active le profil et reste focusable avec la telecommande. La fiche inline permet Modifier, Synchroniser et Supprimer sans popup detail intermediaire.
