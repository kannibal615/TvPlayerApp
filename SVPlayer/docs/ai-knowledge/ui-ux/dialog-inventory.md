...
| `SmartVisionQrDialog` | Route vers un QR seul ou le dialogue Premium avec QR + code licence. | `ui/profile/ProfileScreen.kt` | Famille Premium unifiee sur le standard visuel Activation/Xtream `680 x 410 dp`, ecran courant conserve sous un scrim noir a 72 % et panneau QR a droite. |
