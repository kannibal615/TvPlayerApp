...
- 2026-07-09: Info compte separe selection et activation des profils. OK sur une ligne profil affiche ses infos dans la section inline en bas, sans popup; le toggle ON/OFF a droite est focusable au D-pad et un seul profil peut etre ON. Les avatars profils affichent la premiere lettre sur une couleur stable.
