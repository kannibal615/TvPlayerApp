...
- Le player plein ecran Live TV a un overlay dedie. D-pad Haut/Bas zappe la chaine precedente/suivante avec l'overlay principal visible ou masque; le premier `ACTION_DOWN` change la chaine et les repetitions sont consommees. Le zapping conserve/affiche l'overlay et relance son timeout. Les panneaux secondaires (Parametres, EPG, sous-titres, luminosite) restent proprietaires de Haut/Bas. Bas ne masque plus l'overlay principal. Gauche/droite navigue les boutons du bandeau; Back ferme d'abord les surfaces secondaires puis revient a la liste Live TV. A la sortie, la liste restaure le focus sur la derniere chaine ouverte, y compris apres zapping.
