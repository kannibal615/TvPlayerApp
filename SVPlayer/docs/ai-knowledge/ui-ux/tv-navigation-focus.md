...
- Live TV Categories: la barre de filtres separe focus et selection; Gauche/Droite parcourt la `LazyRow`, OK applique, Bas cible la premiere categorie visible et Haut conserve la route vers le header. En remontant depuis la premiere categorie, le focus revient au filtre actif. L'icone filtre et le chevron ouvrent le meme selecteur compact, dont Back ferme d'abord le dialog. Apres application, la liste revient en tete et cible le premier dossier filtre.
