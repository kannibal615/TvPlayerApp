...
- Live TV Categories: les filtres sont masques par defaut. OK sur le bouton Filtre affiche/replie la barre inline; Bas entre dans le filtre actif et Bas rejoint ensuite la categorie selectionnee. Haut effectue le chemin inverse. `All` reste premier, la selection applique le filtre sans refermer la barre et les chips gardent leur identite stable.
