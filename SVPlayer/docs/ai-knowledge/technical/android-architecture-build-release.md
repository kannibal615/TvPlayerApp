...
- Le chargement est rendu par un spinner bleu/cyan indetermine: un arc court, dessine une seule fois dans une couche graphique propre, tourne lineairement en boucle de `800 ms` jusqu'a la sortie du Splash. Les changements de statut ne pilotent ni ne relancent cette rotation. Le statut reste sous le cercle; il n'existe plus de barre lineaire.
